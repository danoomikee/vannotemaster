...
import { exportAnnotationsAsCSV, exportAnnotationsAsJSON, importAnnotationsFromJSON } from "@/lib/utils/data-exchange"
...
export default function DashboardPage() {
  ...
  // Hotkeys
  useHotkeys("shift+m", () => handlePauseAndResume(handleDetailedAnnotate), {
    preventDefault: true,
    enabled: !!currentVideo,
  })
  useHotkeys("m", () => handlePauseAndResume(() => quickAnnotationInputRef.current?.focus()), {
    preventDefault: true,
    enabled: !!currentVideo,
  })
  useHotkeys("e", () => handlePauseAndResume(() => setShowEndTimeModal(true)), {
    preventDefault: true,
    enabled: !!currentVideo,
  })
  useHotkeys(
    ...
    { preventDefault: true, enabled: !!currentVideo },
  )
  useHotkeys(
    "arrowright",
    () => {
  ...
  useHotkeys(
    ...
    (e) => {
      e.preventDefault()
      if (!videoRef.current) return
      videoRef.current.isPaused() ? videoRef.current.play() : videoRef.current.pause()
    },
    { enabled: !!currentVideo },
  )
  ...
  useHotkeys("?", () => setShowShortcutsModal(true), { preventDefault: true })
